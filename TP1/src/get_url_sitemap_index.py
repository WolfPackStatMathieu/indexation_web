"""Cette fonction prend en entrée un lien url et 
retourne une string constituée du protocole et du nom de domaine et du sitemap_index.xml
typiquement https://www.monsite.com/sitemap_index.xml
"""
from urllib.parse import urlparse, urlunparse

def get_url_sitemap_index(url):
    ...
    url_sitemap_index = url_base + "/sitemap_index.xml"
    
    return url_sitemap_index
...
if __name__ == '__main__':
    ...
    mon_url_sitemap = get_url_base(mon_url)
    print(mon_url_sitemap)